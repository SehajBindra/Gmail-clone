...
function Login() {
  ...
  return (
    <div className="flex flex-col justify-center items-center px-14 min-h-screen bg-black">
      ...
      <p className="font-xs text-white my-8  line-clamp-2  ">
        This is not a Real App It is Demo Build for Educational Purposes and all
        rights are reserved to Google@2022 and Gmail@2022.
      </p>
